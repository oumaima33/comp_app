{{-- <x-guest-layout>
  ...
  text-align: center;
  border-radius: 10px;
  box-shadow: -3px -3px 7px #ffd5d573,
               2px 2px 5px rgba(121, 94, 98, 0.288);
}
...
.field .input {
  ...
  color: #aaaaaa;
  border-radius: 25px;
  box-shadow: inset 2px 2px 5px #af9cc2,
...
/
/* Style pour le texte sélectionné dans le select */
select option {
  font-weight: normal;
}

/* Style pour le texte désactivé dans le select */
  ...
  <div class="container">
    ...
    <div class="cover">
      <div class="front">
        ...
        <div class="text">
          <span class="text-1">New Competition <br> new adventure</span>
          <span class="text-2">Let's get connected</span>
        </div>
      </div>
      <div class="back">
        <img class="backImg" src="images/image.jpg" alt="">
        <div class="text">
          ...
          @csrf
            <div class="input-boxes">
              ...
              <div class="input-box">
                ...
                <select name="role_id" x-model="role_id"  placeholder="Register as" required>
